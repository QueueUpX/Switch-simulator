...
class MyPanel extends JPanel {
    ...
    void init() {
        ...
        title = new JLabel("<html><h1><u>Analiza comutatorului spatial cu 3 stagii, cu blocare</u></h1></html>", JLabel.CENTER);
        N = new JLabel("<html><h2>N, numarul de intrari/iesiri a comutatorului<br/>N = valoare " +
                "intreaga, putere a lui 2</h2></html>");
        k = new JLabel("<html><h2>k, numarul matricilor centrale<br/>k = valoare intreaga, 1 &#60 k &#60 2*n-1</h2></html>");
        p = new JLabel("<html><h2>p, fractie din timpul total in care o intrare este activa<br/>" +
                "p = valoare intreaga, 0 &#60 p &#60 100</h2></html>");
    ...
    void addComponents() {
        ...
        clear.add(Box.createRigidArea(new Dimension(1170,80)));
