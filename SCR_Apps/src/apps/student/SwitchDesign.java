...
public class SwitchDesign extends JPanel {
    private final String TITLE = "<html><h1>Proiectare de comutatoare</h1></html>";
    private final String STS = "<html><h2>Proiectare comutator STS</h2></html>";
    private final String TST = "<html><h2>Proiectare comutator TST</h2></html>";
