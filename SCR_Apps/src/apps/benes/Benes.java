...
public class Benes extends JFrame {
    ...
    private void init() {
        panel = new JPanel();
        label1 = new JLabel("<html><h1>Introduceti numarul de abonati:</h1></html>");
        ...
        build.addActionListener(e -> {
            ...
            if(textField1.getText().equals("")) {
                ...
                JOptionPane.showMessageDialog(this,
                        "<html><h2 style='color:red'>Numarul de abonati trebuie sa fie &#8805 4</h2></html>");
            }
            else if(Integer.parseInt(textField1.getText()) % 2 != 0){
                JOptionPane.showMessageDialog(this,
                        "<html><h2 style='color:red'>Numarul de abonati trebuie sa fie divizibil cu 2</h2></html>");
            }
            else {
