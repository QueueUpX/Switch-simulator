...
class MyPanel extends JPanel {
    ...
    void init() {
        design = new JButton("<html><h2>Clos Switch Design</h2></html>");
        clear = new JButton("<html><h3>Clear</h3></htlm>");
        title = new JLabel("<html><h1><u>3-Stage space switch analysis, with blocking</u></h1></html>", JLabel.CENTER);
            ...
            public void setValueAt(Object aValue, int row, int column) {
                ...
                try {
                    ...
                    if(errors.isSelected()) {
                        if(k < n/2) {
                            output.setValueAt("<html><h4>Warning: k &#60 " + n/2 +"</h4></html>", 1, column);
                        }
                    }
    ...
    void setup() {
        ...
        design.setMaximumSize(new Dimension(200,30));
        design.setFocusable(false);
        design.addActionListener(e -> {
            this.getParent().add(new ClosDesign());
    ...
    void addComponents() {
        ...
        N.add(this.N);
        N.add(design);
        N.add(Box.createRigidArea(new Dimension(50,0)));
        this.add(N);
